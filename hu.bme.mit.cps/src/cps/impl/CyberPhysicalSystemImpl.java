 ...
 * </p>
 * <ul>
 *   <li>{@link cps.impl.CyberPhysicalSystemImpl#getTasks <em>Tasks</em>}</li>
 *   <li>{@link cps.impl.CyberPhysicalSystemImpl#getComputers <em>Computers</em>}</li>
 *   <li>{@link cps.impl.CyberPhysicalSystemImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CyberPhysicalSystemImpl extends MinimalEObjectImpl.Container implements CyberPhysicalSystem {
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectResolvingEList<Task>(Task.class, this, CpsPackage.CYBER_PHYSICAL_SYSTEM__TASKS);
		}
		return tasks;
	}
	...
	public EList<Computer> getComputers() {
		if (computers == null) {
			computers = new EObjectResolvingEList<Computer>(Computer.class, this, CpsPackage.CYBER_PHYSICAL_SYSTEM__COMPUTERS);
		}
		return computers;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsPackage.CYBER_PHYSICAL_SYSTEM__NAME, oldName, name));
	}
