...
public class CyberPhysicalSystemImpl extends MinimalEObjectImpl.Container implements CyberPhysicalSystem {
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList<Task>(Task.class, this, CpsPackage.CYBER_PHYSICAL_SYSTEM__TASKS);
		}
		return tasks;
	}
	...
	public EList<Computer> getComputers() {
		if (computers == null) {
			computers = new EObjectContainmentEList<Computer>(Computer.class, this, CpsPackage.CYBER_PHYSICAL_SYSTEM__COMPUTERS);
		}
		return computers;
	}
