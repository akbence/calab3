...
/**
 * This is the item provider adapter for a {@link cps.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerItemProvider extends TaskItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_task_feature", "_UI_Controller_type"),
				 CpsPackage.Literals.CONTROLLER__TASK,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Severity labelValue = ((Controller)object).getSeverity();
